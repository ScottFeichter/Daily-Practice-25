...
impl AuthenticationService {
    ...
    pub async fn validate_credentials(&self, email_param: &str, password: &str) -> Result<User, Error> {
    ...
    pub fn verify_access_token(&self, token: &str) -> Result<TokenClaims, jsonwebtoken::errors::Error> {
    ...
    pub fn verify_refresh_token(&self, token: &str) -> Result<TokenClaims, jsonwebtoken::errors::Error> {
        let validation = Validation::new(Algorithm::HS256);
        let token_data = decode::<TokenClaims>(
            token,

fn main() {
  ...
  // CRATE - basically a .rc file
  // Binary Crate - are programs that compile and run and must have a main function
  // Library Crate - don't compile or run and don't have a main function

...
const nums1: number[] = [0, 1, 2, 3] // no dups
const nums2: number[] = [1, 2, 3, 3] // one dup
const nums3: number[] = [1, 1, 2, 2, 3] // two dups
const nums4: number[] = [1, 2, 3, 3, 3] // a triple dup
const nums5: number[] = [] // edge empty array
const nums6: number[] = [1] // edge single element array
const nums7: any[] = [1, 'a', 3.3, "four!", 1] // not applicable because should be only nums
